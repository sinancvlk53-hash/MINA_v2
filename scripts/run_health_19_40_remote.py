...
"""19-40 sağlık raporu — state sync + lokal çalıştır."""
import os
import subprocess
import sys
...
def main() -> None:
    script = os.path.join(LOCAL_ROOT, "scripts", "health_report_19_40.py")
    out_path = os.path.join(LOCAL_ROOT, "health_19_40_out.txt")
    sync_from_server()
    env = os.environ.copy()
