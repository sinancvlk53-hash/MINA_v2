...
ENV_PATH = os.getenv("MINA_ENV_PATH", "/root/MINA_v2/.env")
NEW_KEY = os.getenv("BINANCE_NEW_API_KEY", "")
NEW_SECRET = os.getenv("BINANCE_NEW_API_SECRET", "")
...
def main():
    ...
    if not NEW_KEY or not NEW_SECRET:
        print(
            "HATA: BINANCE_NEW_API_KEY ve BINANCE_NEW_API_SECRET ortam degiskenleri zorunlu.\n"
            "Ornek (Linux): export BINANCE_NEW_API_KEY=... BINANCE_NEW_API_SECRET=...",
            file=sys.stderr,
        )
        sys.exit(1)
